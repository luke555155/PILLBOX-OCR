...
QUANTITY_KEYWORDS = {
    'zh-tw': ['數量', '含量', '劑量', '每日劑量', '錠', '每日用量', '用量', '毫克', '微克', '公克', '公斤', '毫升', '克', 'mg', 'mcg', 'g', 'ml'],
    'zh-cn': ['数量', '含量', '剂量', '每日剂量', '锭','每日用量', '用量', '毫克', '微克', '公克', '公斤', '毫升', '克', 'mg', 'mcg', 'g', 'ml'],
    'en': ['quantity', 'amount', 'dosage', 'daily dose', 'ingot', 'dose', 'milligram', 'microgram', 'gram', 'kilogram', 'milliliter', 'mg', 'mcg', 'g', 'ml'],
    'ja': ['数量', '含量', '用量', '1日量', '投与量', '錠', 'ミリグラム', 'マイクログラム', 'グラム', 'キログラム', 'ミリリットル', 'mg', 'mcg', 'g', 'ml'],
    'ko': ['수량', '함량', '용량', '일일 용량', '투여량', '주괴', '밀리그램', '마이크로그램', '그램', '킬로그램', '밀리리터', 'mg', 'mcg', 'g', 'ml']
}
